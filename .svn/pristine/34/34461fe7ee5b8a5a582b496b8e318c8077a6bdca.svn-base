...
<head>
	...
	<body>
			...
			<ul class="nav nav-list" style="border-right:2px solid #438EB9 ;">
				<li class="active open">
					...
					<ul class="submenu">
						<li>
							<a href="/fam/AppInformationServlet" target="mainFrame">
								<i class="icon-double-angle-right"></i> 申报列表
							</a>
						</li>
					</ul>
				</li>
				<li class="active open">
					...
					<ul class="submenu">
						<li>
							<a href="pwd.jsp" target="mainFrame">
				...
				<li class="active open">
					...
					<ul class="submenu">
						<li>
							<a href="/fam/AppInformationReultServlet" target="mainFrame">
								<i class="icon-double-angle-right"></i> 申请用户判定
							</a>
						</li>

						<li>
							<a href="/fam/AppInformationDelServlet" target="mainFrame">
								<i class="icon-double-angle-right"></i> 申请用户删除
							</a>
						</li>
					</ul>
				</li>
