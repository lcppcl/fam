									...
									<table id="sample-table-2"
										...
										<thead>
											<tr>
												...
												<th width="200">
													<i class="icon-upload bigger-110 hidden-480"></i> 申报状况</th>
												<th width="200">
													<i class="icon-time bigger-110 hidden-480"></i> 荣誉称号</th>
												<th width="200">
											...
											<tr>
												...
												<td>
													<div style="position: relative; left: 50px;"
														...
														<form action="/fam/ManDelServlet" method="post">
															<input type="hidden" value="<%=app.getApplyName() %>" name="del">
														<input type="submit" class="btn btn-xs btn-danger" style="width:70px" data-rel="tooltip"
															title="删除">
														</form>
													</div>
												</td>
